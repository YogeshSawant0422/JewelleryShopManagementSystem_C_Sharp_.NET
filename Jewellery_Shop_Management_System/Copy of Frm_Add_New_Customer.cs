    ...
    public partial class Frm_Add_New_Customer : Form
    {
        ...
        private void btn_Add_Click(object sender, EventArgs e)
        {
            ...
            {               
                ...
                cmb_Sub_Category.Enabled = false;
                cmb_Product_Name.Enabled = false;
                cmb_Purity.Enabled = false;
                tb_Net_Wt.Enabled = false;
        ...
        {
            cmb_Sub_Category.Enabled = true;
        }

        private void cmb_Sub_Category_TextChanged(object sender, EventArgs e)
        {
        ...
        {
            cmb_Purity.Enabled = true;
        }

        private void cmb_Purity_TextChanged(object sender, EventArgs e)
        {
            tb_Net_Wt.Enabled = true;
        }

        private void tb_Net_Wt_TextChanged(object sender, EventArgs e)
        {
